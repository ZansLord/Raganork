...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*MADE BY RAGANORK*' : process.env.ALL_CAPTION,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/abdulmalik_4342' : process.env.IG,
    ...
    SKV: process.env.V_HEADER === undefined ? '*AHH YAMETEH*' : process.env.V_HEADER,
    SKDR: process.env.DURATION === undefined ? '99978509' : process.env.DURATION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '6285869074622' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
